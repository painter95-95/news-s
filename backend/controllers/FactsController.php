...
Yii::setAlias('newsfolder', dirname(dirname(__DIR__)) . '/frontend/web/images/facts/');
...
class FactsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if (!empty($model->logo)){
                ...
                $image->resize(new Box(340, 213))->save(Yii::getAlias('@newsfolder/list/'.$model->logo, ['quality' => 70]));
    ...
    {
        if ($this->findModel($id)->deleteFacts($id)){
