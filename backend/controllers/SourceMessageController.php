...
class SourceMessageController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $translation = [
            'uz' => Yii::$app->request->post('uz_text'),
            'uc' => Yii::$app->request->post('uc_text'),
            'ru' => Yii::$app->request->post('ru_text'),
            'kor' => Yii::$app->request->post('kor_text'),
        ];
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            foreach ($translation as $key => $value){
               $model->messageSave($model->id, $key, $value);
