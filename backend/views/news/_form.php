            ...
            <div class="col-md-12">
                    <div class="porlets-content">
                        ...
                        <div class="porlets-content">
                            ...
                            echo $form->field($model, 'type_cat')->dropDownList($items_d,$params_d);
                            ?>
                            ...
                            <?
                            $items = ArrayHelper::map(\common\models\Cat::find()->all(), 'id', 'name_uz');
                            $params = [
                            ...
                            <hr>
                            <div class="form-group">
                                <?= Html::submitButton($model->isNewRecord ? Yii::t('app', 'Добавить <span class="btn-label btn-label-right"><i class="fa fa-check"></i></span>') : Yii::t('app', 'Обновить <span class="btn-label btn-label-right"><i class="fa fa-check"></i></span>'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-success btn-labeled pull-right']) ?>
                            </div>
                            </div>
                            <?php ActiveForm::end(); ?>
                    </div><!--/porlets-content-->
