...
class ArticleSearch extends Article
{
    ...
    {
        return [
            [['id', 'cat_id', 'type_id', 'status', 'author'], 'integer'],
            [['logo', 'title_uz', 'title_ru', 'title_en', 'title_uc', 'mini_desc_uz', 'mini_desc_ru', 'mini_desc_en', 'mini_desc_uc', 'desc_uz', 'desc_ru', 'desc_en', 'desc_uc', 'token', 'create_at', 'update_at'], 'safe'],
        ];
    }
