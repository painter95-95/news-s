(function($) {
    ...
    $('.languages-select > span').on('click .languages-drop', function(event){
...
function subscribeFunction()
{
    $.ajax({
        ...
        success: function (data) {
            ...
            $('.success-ajax').attr('style', 'display:block');
            $('.error-ajax').attr('style', 'display:none');
        },
        error:function (data) {
            $('.success-ajax').attr('style', 'display:none');
            $('.error-ajax').attr('style', 'display:block');
            $('#loader').attr('style', 'display:none');
        },
        complete: function() {
