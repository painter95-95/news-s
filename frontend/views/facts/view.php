    ...
    <div class="row">
        ...
        <div class="col-md-8 col-sm-7 padding-bottom-30">
            <div class="blog-excerpt">
                ...
                <img src="<?=Url::to('@web/images/facts/single/'.$model->logo)?>" class="img-responsive" alt="<?=$model->langTitle();?>"/>
            ...
            <div class="row margin-bottom-30">
                <div class="col-md-4">
                    <div class="layout_2--item">
                        <div class="thumb">
                            <a href="#" ><img src="<?=Url::to('@web/images/facts/single/'.$model->logo)?>" class="img-responsive" alt=""></a>
                        </div>
        ...
        <?= $this->render('_sidebar', ['news' => $news, 'articles' => $articles, 'reklama' => $reklama, 'follow' => $follow]); ?>
    </div>
</div>
<!-- // CONTENT -->
